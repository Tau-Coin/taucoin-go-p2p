...
// Package errors provides common error types used throughout ipfsdb.
package errors
...
// Common errors.
var (
	ErrNotFound    = New("ipfsdb: not found")
	ErrReleased    = utils.ErrReleased
	ErrHasReleaser = utils.ErrHasReleaser
)
